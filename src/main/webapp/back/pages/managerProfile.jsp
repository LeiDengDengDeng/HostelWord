                            ...
                            <div class="col-lg-6">
                                <form role="form" id="form">
                                    <div class="form-group">
                                        <label>经理识别码</label>
                                        <input class="form-control" id="managerId" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label>经理资金/元</label>
                                        <input class="form-control" id="money" name="money" disabled>
                                    </div>
                                </form>
                            </div>
                        </div>
        ...
        function loadProfile() {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (jsonData.success) {
                        var managerId = window.document.getElementById("managerId");
                        managerId.value = jsonData.data.id;
                        var money = window.document.getElementById("money");
                        money.value = jsonData.data.money;
                    }
                }
            })
        }
