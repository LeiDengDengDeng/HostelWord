...
<script>
                ...
                if (jsonData.success) {
                    ...
                    for (var i = 0; i < jsonData.data.hostels.length; i++) {
                        ...
                        str += "<tr>" +
                            ...
                            "<td>" + hostel.money + "</td>" +
                            "<td>" + hostel.earnMoney + "</td>" +
                            "<td>" + hostel.totalEarnMoney + "</td>" +
                            "<td> <input type=\"num\" id=" + id + "> </td>" +
                            "<td> <input type=\"button\" value=\"结算\" onClick=\"settle(+" + hostel.id + "," + i + ")\"> </td>";
                        "</tr>";
                    }
                    tbody.innerHTML = str;
                } else {
    ...
    function settle(id, i) {
        var money = window.document.getElementById("num" + i);
        $.ajax({
            type: "GET",
            datatype: "json",
            url: "/back/manager/settle.do",
            data: {
                hostelId: id,
                money: money.value
            },
            ...
            success: function (data) {
                ...
                if (jsonData.success) {
                    alert("结算成功");
                    window.location.href = "/back/pages/managerSettle.jsp";
                } else {
                    alert(jsonData.msg);
                }
            }
