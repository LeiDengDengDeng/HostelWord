...
<head>
    ...
    <script type="text/javascript">
        window.onload = function () {
            ...
            var ul = window.document.getElementById("fh5co-primary-menu");
            var li = document.createElement("li");
            var href_a = document.createElement("a");
            if (account == null) {
                href_a.href = "login.jsp";
                href_a.innerHTML = "登录";
            } else {
                href_a.href = "profile.jsp";
                href_a.innerHTML = account;
            }
                ...
                <div class="row">
                    <div id="availability">
                        <form action="#">
                            <div class="a-col">
                                <%--<section>--%>
                                <%--<select class="cs-select cs-skin-border" id="hostelMenu">--%>
                        ...
                        <div class="image" style="background-image: url(images/hotel_feture_1.jpg);">
                            <div class="descrip text-center">
                                <p>
                                    ...
                                    <span>$100/night</span></p>
                            </div>
                        </div>
                        <div class="desc">
                            <h3>Deluxe Hotel</h3>
                            <p>Pellentesque habitant morbi tristique senectus et netus ett mauada fames ac turpis
                                egestas. Etiam euismod tempor leo, in suscipit urna condimentum sed. Vivamus augue enim,
                                consectetur ac interdum a, pulvinar ac massa. Nullam malesuada congue </p>
                        ...
                        <div class="f-hotel">
                            <div class="image" style="background-image: url(images/hotel_feture_2.jpg);">
                                <div class="descrip text-center">
                                    <p>
                                        <small>For as low as</small>
                                        <span>$99/night</span></p>
                                </div>
                            </div>
                            <div class="desc">
                                <h3>Hotel Bora</h3>
                                <p>Pellentesque habitant morbi tristique senectus et netus ett mauada fames ac turpis
                                    egestas. Etiam euismod tempor leo,
                            ...
                            <p>
                                <small>&copy; 2016 Free HTML5 Template. <br> All Rights Reserved. <br>
                                    More Templates <a href="http://www.cssmoban.com/" target="_blank"
                                            ...
                                            href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a> <br>
